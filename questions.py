questions = [
    ...
    {
        "id": 6,
        "question": "What kind of call do I love the most with you?",
        "options": ["Morning call", "Random call 💕", "Late night call 🌙", "Video call only"],
        "correct": "Random call 💕",
        "weight": 3
    },
    {
    ...
    {
        "id": 12,
        "question": "My favourite drink is…",
        "options": ["Coca Cola", "Teh Ais", "Spritzer Mineral Water 💧", "Coffee"],
        "correct": "Spritzer Mineral Water 💧",
        "weight": 2
    },
    {
        "id": 13,
